...
def render( data ):
    ...
    alphaChannelFunc.AddPoint(data.max(), 0.65)
    ...
    # to store them in a class that stores volume prpoperties.
    ...
    writer.SetFileName("rbc_stackVTK.png")
