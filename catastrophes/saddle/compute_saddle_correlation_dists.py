...
# data path
prefix = '/sciclone/data10/jberwald/climate_attractors/saddle_node_corr/saddle_corr'
vrfile = '/sciclone/scr10/jberwald/saddle_corr' #'./data/sadde_'
...
window_sizes = range( 10, 60, 10 )  # 10-->50, by 10
