import numpy as np
from pytopTools.perseus import perseus
...
def perseus_sub_super( mat, tmpPerseus, scale,
    ...
    perseus.perseus( perseus_in, perseus_out, pers_type )
    perseus.perseus( perseus_in_sup, perseus_out_sup, p )
    ...
    for d in range( max_dim + 1 ):
        ...
        if got_super:
            ...
            # super-level sets.
            inf_idx = np.where( Psup[:,1] == -1 )[0] #find( Psup(:,2) == -1 );
