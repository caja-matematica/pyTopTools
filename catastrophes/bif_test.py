from pyTopTools import persistence_tools as P
from pyTopTools import perseus_wrap as pw


pt = P.Data( 'sandbox/genbif0.txt', 'timeseries' )

block = 200
pname = '/Users/jberwald/github/local/caja-matematica/pyTopTools/sandbox/genbif_pers'
for t in range( 6000, 8400, 100 ):
